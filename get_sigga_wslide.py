...
def main(portfolio_date, options):
    ...
    for i, asset_ticker in enumerate(common.stock_tickers):
        ...
        genome = Genome(standardized_returns, lead_lag=2, signature_level=1,best_ga_file=best_ga_file)    
        population_size = 100
        num_generations = 100              
...
class Genome:
    ...
    def __init__(self,standardized_returns, lead_lag=2, signature_level=1, chromosone_length=5, best_ga_file=None  ):
